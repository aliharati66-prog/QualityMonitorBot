...
class Program
{
    ...
    static async Task SaveFeedback(UserState state)
    {
        try
        {
            ...
            var currentClass = Classes.FirstOrDefault(c => c.ClassCode == state.SelectedClassCode);
            ...
            var studentTexts = new Dictionary<int, Dictionary<string, string>>()
            {
                ...
                [2] = new() { ["1"] = "یکنواخت", ["2"] = "ایستا", ["3"] = "متعادل", ["4"] = "پویا", ["5"] = "بسیار محرک" },
                [3] = new() { ["1"] = "عدم پیگیری", ["2"] = "نامنظم", ["3"] = "استاندارد", ["4"] = "دقیق", ["5"] = "تحلیلی" },
                [4] = new() { ["1"] = "بسیار رسمی", ["2"] = "خشک", ["3"] = "معتدل", ["4"] = "گرم", ["5"] = "بسیار صمیمی" },
                [5] = new() { ["1"] = "بسیار زیاد", ["2"] = "زیاد", ["3"] = "متعادل", ["4"] = "کم", ["5"] = "بسیار کم" },
                [6] = new() { ["1"] = "نامناسب", ["2"] = "ضعیف", ["3"] = "متعادل", ["4"] = "خوب", ["5"] = "الگو" },
            ...
            var teacherTexts = new Dictionary<int, Dictionary<string, string>>()
            {
                ...
                [2] = new() { ["1"] = "ضعیف", ["2"] = "متوسط پایین", ["3"] = "قابل قبول", ["4"] = "خوب", ["5"] = "عالی" },
                [3] = new() { ["1"] = "ضعیف", ["2"] = "متوسط پایین", ["3"] = "قابل قبول", ["4"] = "خوب", ["5"] = "عالی" },
                [4] = new() { ["1"] = "ضعیف", ["2"] = "متوسط پایین", ["3"] = "قابل قبول", ["4"] = "خوب", ["5"] = "عالی" },
                [5] = new() { ["1"] = "ضعیف", ["2"] = "متوسط پایین", ["3"] = "قابل قبول", ["4"] = "خوب", ["5"] = "عالی" },
                [6] = new() { ["1"] = "ضعیف", ["2"] = "متوسط پایین", ["3"] = "قابل قبول", ["4"] = "خوب", ["5"] = "عالی" },
                [7] = new() { ["1"] = "ضعیف", ["2"] = "متوسط پایین", ["3"] = "قابل قبول", ["4"] = "خوب", ["5"] = "عالی" },
                [9] = new() { ["1"] = "نیاز فوری", ["2"] = "نقاط ضعف مشخص", ["3"] = "نیاز به تمرین", ["4"] = "ضعف جزئی", ["5"] = "ضعف عمده ندارد" },
                [10] = new() { ["1"] = "عدم علاقه", ["2"] = "منفعل", ["3"] = "معمول", ["4"] = "مشتاق", ["5"] = "بسیار مشتاق" },
                [11] = new() { ["1"] = "عدم آمادگی", ["2"] = "ناقص", ["3"] = "متوسط", ["4"] = "کامل", ["5"] = "فراتر از انتظار" }
            };

            if (state.Role == "student")
            {
                range = "Teacher_Feedback!A:T";
            ...
            else // teacher
            {
                ...
                if (currentClass != null)
                {
                    var student = currentClass.Students.FirstOrDefault(s => s.TelegramId == state.SelectedStudentId);
